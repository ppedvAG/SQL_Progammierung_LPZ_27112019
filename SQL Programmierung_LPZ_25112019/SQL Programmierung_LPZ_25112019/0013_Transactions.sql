...
--ISOLATION LEVELS
-- READ COMMITTED Schreiben exklusiv
-- READ UNCOMMITTED Schreiben erlaubt Lesen
-- REPEATBALE READ  Lesen hindert updates
-- Serialzable  LESEN hindert inserts
...
--Niveau der Sperre: DB, TAB, ZEILE, SEITE, BLOCK
--Zeile: row, Page (evtl DS gesperrt, die man gar nicht ändert, Block)

--Warum aber passiert immer das.. Bei jedem Update auf eine Zeile wird immer die Tab gesperrt??
--Index!
